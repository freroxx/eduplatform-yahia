  ...
  const videos = [
    {
      ...
      difficulty: "Débutant",
      views: "25.4K",
      description: "Une introduction claire et accessible aux différents ensembles de nombres N, Z, Q, D et R",
    ...
    },
    {
      ...
      views: "18.2K",
      description: "Comprendre les relations d'inclusion et les propriétés des différents ensembles de nombres",
    ...
    },
    {
      ...
      difficulty: "Avancé",
      views: "12.8K",
      description: "Résolution d'exercices types sur la classification des nombres avec méthodes détaillées",
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-gray-200/50 p-4 sticky top-0 z-50">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="text-center">
            <h1 className="text-xl font-bold text-gray-800">Vidéos YouTube</h1>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 text-lg">Complétez votre apprentissage avec ces vidéos explicatives sélectionnées</p>
                ...
                <CardContent>
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button 
                      ...
                      className="bg-red-600 hover:bg-red-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 flex-1 py-3"
                    >
                    ...
                    <Button 
                      variant="outline" 
                      onClick={() => handleVideoClick(video.id, video.url)}
                      className="border-gray-300 hover:bg-gray-50 transition-all duration-200 hover:border-gray-400"
                    >
          ...
          <div className="mt-12 text-center">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Besoin de plus d'aide ?</h3>
              <p className="text-gray-600 mb-4">Consultez nos exercices pratiques et notre cours interactif</p>
